...
insert into public.site_settings (key, value) values
  ('brand_name',              'Green Basket TCR'),
  ('tagline',                 'Your Kitchen, Simplified'),
  ('contact_phone',           '+91 90481 78886'),
  ('contact_email',           'info@greenbaskettcr.com'),
  ('contact_address',         'Green Basket Tcr, Near Ayyanthole Ground, Thrissur, Kerala - 680003.'),
  ...
  ('instagram_url',           'https://www.instagram.com/greenbaskettcr?igsi=MWR2aGZja3Z0dXB6OA=='),
  ('facebook_url',            'https://www.facebook.com/share/1D6LKpc5Rx/'),
  ('whatsapp_number',         '+919048178886'),
