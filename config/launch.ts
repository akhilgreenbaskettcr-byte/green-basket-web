/**
 * Website Launch & Maintenance Configuration
 *
 * COMING_SOON_MODE:
 * - When set to `true`: All public visitors see the "Launching Soon" page.
 * - When set to `false`: The full website is live to the public!
 *
